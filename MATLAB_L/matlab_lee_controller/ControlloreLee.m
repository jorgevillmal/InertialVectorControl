...
% The "ControllerLee" MATLAB function computes the forces applied to the
% aircraft as described in the Lee's paper available at this link:
% 
% https://arxiv.org/pdf/1003.2005.pdf
%
% Inputs:
% - xd, the desired trajectory in \mathbb{R}^3. It contains 
% - bld, the vector \in \mathbb{R}^3
% - x, the drone position \in \mathbb{R}^3. Inertial frame. See the paper
% for the reference system
% - v, the drone velocity \in \mathbb{R}^3. Inertial frame. See the paper
% for the reference system (NED or ENU)
% - R, the rotation matrix from body to world
% - Omega, the angular velocity \in \mathbb{R}^3. Body frame. See the paper
% for the reference system, i.e., how the axes are oriented with the
% respect to the center of mass
% - t, the time \in \mathbb{R}
